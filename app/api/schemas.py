...
class PredictionRequest(BaseModel):
    ...
    nombre_heures_travailless: float = Field(..., json_schema_extra={"example": 80})
    ...
    nombre_employee_sous_responsabilite: float = Field(..., json_schema_extra={"example": 0})
    ...
    ayant_enfants: str = Field(..., json_schema_extra={"example": "Oui"})
